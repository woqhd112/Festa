...
<div class="report_wrap pop_wrap">
	...
	<form id="reportForm" class="comm_form" method="POST" action="${root}camp/detail/report" enctype="multipart/form-data">
		...
		<input type="hidden" name="canum" value="${campReport.canum}">
		<input type="hidden" name="pronum_sync" value="${campReport.profile.pronum}">
		<input type="hidden" name="rltarget" value="${campReport.profile.proname}">
		<input type="hidden" name="targetid" value="${campReport.profile.proid}">
		<div class="file_box">
