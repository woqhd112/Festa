...
<div class="report_wrap pop_wrap">
	...
	<form class="comm_form" id="form_data" method="post" enctype="multipart/form-data">
		...
		<input type="hidden" name="pronum_sync" value="${groupFeed.profile.pronum }">
		<input type="hidden" name="rltarget" value="${groupFeed.profile.proname }">
		<input type="hidden" name="targetid" value="${groupFeed.profile.proid }">
		<input type="hidden" name="gpnum" value="${groupFeed.gpnum }">
		<div class="file_box">
