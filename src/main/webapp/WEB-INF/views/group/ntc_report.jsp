...
<div class="report_wrap pop_wrap">
	...
	<form class="comm_form" id="form_data" method="post" enctype="multipart/form-data">
		...
		<input type="hidden" name="pronum_sync" value="${groupNotice.profile.pronum }">
		<input type="hidden" name="rltarget" value="${groupNotice.profile.proname }">
		<input type="hidden" name="targetid" value="${groupNotice.profile.proid }">
		<input type="hidden" name="gnnum" value="${groupNotice.gnnum }">
		<div class="file_box">
