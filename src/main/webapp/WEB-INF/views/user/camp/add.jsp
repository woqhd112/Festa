		...
		$('#rst').on('submit',function(e){
			...
			$.ajax({
				...
				success:function(data){
					$.post('${root}camp/detail/bookadd',"pronum="+${profile.pronum}+'&canum='+data.canum);
					openPop('updateOk');
					...
					<ul class="lnb_list">
						...
						<c:if test="${myVenture ne null }">
							<c:if test="${campCheck == 0 }">
								<li><a href="${root}user/camp/add" class="act">캠핑장 등록</a></li>
							</c:if>
						</c:if>
						<!-- 사업자계정 등록 전 { -->
					</ul>
							...
							<li class="box">
								...
								<div>
									<input type="text" class="rd_only" id="caname" name="caname"
										value="${myVenture.mvname }" readonly="readonly">
								</div>
							</li>
							<li class="box">
								<p>
							...
							<li class="box">
								...
								<div>
									<input type="text" class="rd_only" id="caaddr" name="caaddr"
										value="${myVenture.mvaddr }" readonly="readonly">
								</div>
							</li>
							<li class="box">
								<div>
