		...
		<section class="profile_area">
			<div class="container">
				<div class="info_box">
					<dl>
						<dt class="pf_tit">
							<a class="pf_name" href="${root }user/?pronum=${profile.pronum}"><b>${login.proname }</b></a>
							<!-- 마이페이지일 경우 톱니바퀴 버튼 {  -->
		...
		<div class="container">
			...
			<section class="side_area">
				<ul class="lnb_list">
					...
					<li><a href="${root}user/venture/standby" class="act">사업자 계정 신청</a></li>
					</c:if>
					</c:if>
					<!-- 사업자이면서 캠핑장 있는 경우 -->
					<c:if test="${myVenture ne null }">
			...
			<section class="content_area">
				...
				<div class="set_standby">
					...
					<p class="comm_buttons">
						<a class="btn_home comm_btn cfm" href="${root }user/?pronum=${profile.pronum}">마이페이지로 돌아가기</a>
					</p>
				</div>
			</section>
			<!-- } 컨텐츠영역 끝 -->
